<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nosotros.aspx.cs" Inherits="org_jwonkanet_gui_Nosotros" %>
...
<section class="box-content box-2 box-style-0" id="box-slide" data-anchor="slide">
            <div class="flex-box no-gutter">
                <div class="col-xs-12 col-sm-6 text-center" style="padding-top: 8%">
                    <img src="img/logo.png" class="img-responsive" alt="Café">
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="box-text light-style">
                        <div class="box-text-inner pd-exlarge-lg pd-medium-md pd-small-xs">
                            <div class="heading">
                                <h2><span>Sobre</span> <span>KAD's</span> </h2>
                            </div>
                            <p style="font-size: 16px">Érase una vez un grupo de soñadores que tenían la ilusión de llegar lado al otro del mundo. Su historia comenzó hace más de 100 años en un lugar de León México y gracias a los juguetes, han coseguido su sueño</p>
                        </div>
                    </div>
                </div>
            </div>
