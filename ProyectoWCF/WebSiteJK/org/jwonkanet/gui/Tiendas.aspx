<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tiendas.aspx.cs" Inherits="org_jwonkanet_gui_Tiendas" %>
        ...
        <div class="row row2">
            <div class="col-sm-2">
                ...
                <h1 style="margin:0px; text-align: center;"><span class="largenav">
                	<a href="Index.html"><img src="img/logo.png" alt="KAD's" style="max-height: 60px" class="img-responsive"></a>
                </span></h1>
            </div>
...
<div class="container" style="margin-top: 30px">
    <div class="row-fluid">
        ...
        <div class="span4">
            <h2>Sucursal 1</h2>
            <address>
                <strong>León Guanajuato</strong><br>
                Av Universidad<br>
                Lomas<br>
                del<br>
                Campestre<br>
