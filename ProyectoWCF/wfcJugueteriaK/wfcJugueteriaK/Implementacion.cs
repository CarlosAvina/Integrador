...
namespace wfcJugueteriaK
{
    ...
    //das
    public class ImplementacionJS : Contratos
    {
        ...
        public Empleado RegistrarEmpleado(Empleado empleado)
        {
            ...
            try
            {
                ...
                conexion.InitialSQLStatement("dbo.pa_ins_Empleado", System.Data.CommandType.StoredProcedure);
                ...
                conexion.SetParameterProcedure("@Fotografia", System.Data.ParameterDirection.Input, eTypes.Cadena, empleado.persona.fotografia);
                conexion.SetParameterProcedure("@Rfc", System.Data.ParameterDirection.Input, eTypes.Cadena, empleado.persona.rfc);
                ...
                //rol
                conexion.SetParameterProcedure("@Descripcion", System.Data.ParameterDirection.Input, eTypes.Cadena, empleado.usuario.rol.descripcion);
                //id out
                conexion.SetParameterProcedure("@id", System.Data.ParameterDirection.Output, eTypes.Entero, null);
                tempE.id = long.Parse(conexion.ExecuteStoredOutPut().ToString());
                return tempE;
            }
            catch (Exception ex)
            {
        ...
        public Cliente RegistrarCliente(Cliente cliente)
        {
            ...
            try
            {
                ...
                conexion.InitialSQLStatement("dbo.pa_ins_Cliente", System.Data.CommandType.StoredProcedure);
        ...
        public List<Cliente> ConsultarCliente()
        {
            ...
            try
            {
                ...
                while (dtr.Read())
                {
                    ...
                    tempC.activo = dtr.GetInt32(dtr.GetOrdinal("Activo"));
                    listC.Add(tempC);
                }
                return listC;
            }
        ...
        public void EliminarCliente(Cliente cliente)
        {
            ...
            try
            {
                //bitacora
                conexion.Open("Data Source = DESKTOP-3N20GVT;" + "Initial Catalog =JugueteriaWonka;" + "User id=sa;Password=sa", RNConnection.DataAbstractionLayer.Proveedor.SQLServer);
                conexion.InitialSQLStatement("dbo.pa_del_Cliente", System.Data.CommandType.StoredProcedure);
        ...
        public void UpdateCliente(Cliente cliente)
        {
            ...
            try
            {
                //persona
                conexion.Open("Data Source = DESKTOP-3N20GVT;" + "Initial Catalog =JugueteriaWonka;" + "User id=sa;Password=sa", RNConnection.DataAbstractionLayer.Proveedor.SQLServer);
                conexion.InitialSQLStatement("dbo.pa_upd_Cliente", System.Data.CommandType.StoredProcedure);
                conexion.SetParameterProcedure("@IdCliente", System.Data.ParameterDirection.Input, eTypes.Entero, cliente.id);
                conexion.SetParameterProcedure("@Nombre", System.Data.ParameterDirection.Input, eTypes.Cadena, cliente.persona.nombre);
                conexion.SetParameterProcedure("@ApellidoPaterno", System.Data.ParameterDirection.Input, eTypes.Cadena, cliente.persona.apellidoPaterno);
                conexion.SetParameterProcedure("@ApellidoMaterno", System.Data.ParameterDirection.Input, eTypes.Cadena, cliente.persona.apellidoMaterno);
