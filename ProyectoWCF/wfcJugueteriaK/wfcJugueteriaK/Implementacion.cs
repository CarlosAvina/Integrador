...
{
    public class ImplementacionNet : ImplementacionJS,  ContratoJK
    {
        public new long RegistrarEmpleado(Empleado empleado)
        {
            ...
            try
            {
                ...
                conexion.SetParameterProcedure("@Nombre", System.Data.ParameterDirection.Input, eTypes.Cadena, empleado.persona.nombre);
        ...
        public new long RegistrarCliente(Cliente cliente)
        {
            DSL conexion = new DSL();
            long id = 0;
            try
            {
                //persona
                conexion.Open("Data Source = DESKTOP-3N20GVT;" + "Initial Catalog =JugueteriaWonka;" + "User id=sa;Password=sa", RNConnection.DataAbstractionLayer.Proveedor.SQLServer);
                conexion.InitialSQLStatement("dbo.pa_InsertarCliente", System.Data.CommandType.StoredProcedure);
                ...
                //id out
                conexion.SetParameterProcedure("@id", System.Data.ParameterDirection.Output, eTypes.Entero, null);
                cliente.id = long.Parse(conexion.ExecuteStoredOutPut().ToString());
                id = cliente.id;//IdCliente
            }
            catch (Exception ex)
            {
                id = 0;
        ...
        public new long RegistrarProducto(Producto producto)
        {
            DSL conexion = new DSL();
            long id = 0;
            try
        ...
        public new long RegistrarBitacora()
        {
        ...
        public new bool RegistrarDetalleBitacora(Bitacora bitacora, Producto producto, int cantidad, float precioCompra)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new long RegistrarVenta(Empleado empleado, Cliente cliente, FormaPago formaPago)
        {
            ...
            try
            {
                ...
                conexion.SetParameterProcedure("@IdCliente", System.Data.ParameterDirection.Input, eTypes.Entero, cliente.id);
        ...
        public new bool RegistrarDetalleVenta(Venta venta, Producto producto, int cantidad, float precio)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new List<Cliente> ConsultarCliente()
        {
        ...
        public new List<Empleado> ConsultarEmpleado(string filtro)
        {
        ...
        public new List<Producto> ConsultarProducto(string filtro)
        {
        ...
        public new List<DetalleBitacora> ConsultarDetalleBitacora()
        {
        ...
        public new List<Bitacora> ConsultarBitacora()
        {
        ...
        public new List<DetalleVenta> ConsultarDetalleVenta()
        {
        ...
        public new List<Venta> ConsultarVenta()
        {
            ...
            try
            {
                ...
                while (dtr.Read())
                {
                    ...
                    tempV.cliente.id = dtr.GetInt32(dtr.GetOrdinal("IdCliente"));
        ...
        public new bool EliminarCliente(int id)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new bool EliminarEmpleado(int id)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new bool EliminarProducto(int id)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new bool EliminarVenta(int id)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new bool EliminarBitacora(int id)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new bool ActualizarEmpleado(Empleado empleado)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new bool ActualizarCliente(Cliente cliente)
        {
            DSL conexion = new DSL();
            try
            {
        ...
        public new bool ActualizarProducto(Producto producto)
        {
            DSL conexion = new DSL();
            try
            {
    ...
    public class ImplementacionJS : ContratoJSJK
    {
